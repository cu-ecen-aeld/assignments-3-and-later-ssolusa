...
// This structure should be dynamically allocated and passed as an argument to your thread using pthread_create.
// It should be returned by your thread so it can be freed by the joiner thread.

struct thread_data{
    // TODO:
    //     - Add other values your thread will need to manage into this structure.
    //     - Use this structure to communicate between the start_thread_obtaining_mutex function and
    ...
    // Set to true if the thread completed with success. Set to false if an error occurred.
